...
def main():
    ...
    parser.add_argument('--reference', type=str, default='default', help='Reference domain from the config file.')
    ...
    nc_out0 = xr.open_dataset(dicts['ic']['ic_template'])
    nc_out = nc_out0.copy()
