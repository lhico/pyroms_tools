...
def get_nc_CGrid_TPXO8(grdfile, name='TPXO8', \
                       xrange=(4350, 4550), yrange=(6600, 6900), missing_value=-9999, lonoffset=0):
    """
    ...
    lonh = nc.variables['lon_z'][:] + lonoffset
    lath = nc.variables['lat_z'][:]
    lonu = nc.variables['lon_u'][:] + lonoffset
    latu = nc.variables['lat_u'][:]
    lonv = nc.variables['lon_v'][:] + lonoffset
