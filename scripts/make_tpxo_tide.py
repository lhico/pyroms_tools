...
tpxopath = dicts['tpxo.fpath']
xrange   = dicts['tpxo.xrange']
yrange   = dicts['tpxo.yrange']
roms_files = dicts['output_dir']

# tidal constituents
consts1 = dicts['tpxo.consts1']
consts2 = dicts['tpxo.consts2']
...
# read weights file
wts_file_t = f'remap_weights_TPXO8_to_{reference}_bilinear_t_to_rho.nc'
wts_file_u = f'remap_weights_TPXO8_to_{reference}_bilinear_u_to_rho.nc'
wts_file_v = f'remap_weights_TPXO8_to_{reference}_bilinear_v_to_rho.nc'

wts_file_t_lr = f'remap_weights_TPXO8atlas6_to_{reference}_bilinear_t_to_rho.nc'
wts_file_u_lr = f'remap_weights_TPXO8atlas6_to_{reference}_bilinear_u_to_rho.nc'
wts_file_v_lr = f'remap_weights_TPXO8atlas6_to_{reference}_bilinear_v_to_rho.nc'

# read TPXO8 files
srcgrd = CGrid_TPXO8.get_nc_CGrid_TPXO8(tpxogrid, \
...
for cst in consts:
    ...
    if cst in consts1:
        fid = nc.Dataset(tpxopath+'hf.'+cst.lower()+'_tpxo8_atlas_30c_v1.nc', 'r')
        ...
        fid = nc.Dataset(tpxopath+'hf.'+cst.lower()+'_tpxo8_atlas_6.nc', 'r')
    ...
    if cst in consts1:
        fid = nc.Dataset(tpxopath+'uv.'+cst.lower()+'_tpxo8_atlas_30c_v1.nc', 'r')
        ...
        fid = nc.Dataset(tpxopath+'uv.'+cst.lower()+'_tpxo8_atlas_6.nc', 'r')
