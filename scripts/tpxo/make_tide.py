...
# read weights file
wts_file_t = 'remap_weights_TPXO8_to_SBB4_bilinear_t_to_rho.nc'
wts_file_u = 'remap_weights_TPXO8_to_SBB4_bilinear_u_to_rho.nc'
wts_file_v = 'remap_weights_TPXO8_to_SBB4_bilinear_v_to_rho.nc'

wts_file_t_lr = 'remap_weights_TPXO8atlas6_to_SBB4_bilinear_t_to_rho.nc'
wts_file_u_lr = 'remap_weights_TPXO8atlas6_to_SBB4_bilinear_u_to_rho.nc'
