...
mpath  = dicts['bndry.srcgrid']         # source dataset grid
romsgridname = dicts['bndry.gridname']     # grid declared in gridid.txt (roms grid for the model)
srcgridname = dicts['bndry.srcname'] # name of the dataset that provides the info
xrange = dicts['bndry.xrange']       # x indices limits of the source dataset
yrange = dicts['bndry.yrange']       # y indices limits of the source dataset
