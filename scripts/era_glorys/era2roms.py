...
fopen = '../../data/atmos_model/'
outdir = '../../data/roms_files'
atmos_single = sorted(glob.glob(osp.join(fopen, '*single*nc')))
atmos_pressr = sorted(glob.glob(osp.join(fopen, '*pressure*nc')))
atmostr = 'reanalysis-era5-single-levels_%Y-%m-%d.nc'
